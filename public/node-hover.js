...
(() => {
    ...
    function loadLateRefinements() {
        ...
        appendScript('/root-context-refinement.js', 'data-family-root-context-refinement', build);
        ...
        appendScript('/root-selection-coherence.js', 'data-family-root-selection-coherence', build);
